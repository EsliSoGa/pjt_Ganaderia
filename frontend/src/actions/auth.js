...
export const update = (id, Id_rol, Nombre, Correo, Contrasena) => (dispatch) => {
  return AuthService.update(id, Id_rol, Nombre, Correo, Contrasena).then(
    (response) => {
      dispatch({
        type: LOGIN_SUCCESS, // Esto asegura que el usuario actualizado se guarde en el estado
