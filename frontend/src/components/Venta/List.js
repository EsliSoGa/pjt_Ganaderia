...
const VentaList = () =>{
    const {ventas, findVenta} = useContext(VentaContext);
    ...
    const dateVenta = (venta) => {
        return moment(venta.Fecha).format("DD/MM/YYYY");
    }
    ...
    return(
        ...
        <Panel
            header="Listado de ventas aprobadas" sortField="category" sortOrder={-1} responsiveLayout="scroll" 
        ...
        >
            ...
            <DataTable 
                ...
                onSelectionChange={(e) => saveVenta(e.value.id)}
                ...
                <Column field="Fecha" body={dateVenta} header="Fecha de venta" sortable/>
        ...
        <VentaForm isVisible={isVisible} setIsVisible={setIsVisible}/>
        </div>
    );
}
